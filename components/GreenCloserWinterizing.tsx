    ...
    <section className="py-20 bg-green-700 text-white text-center">
      <div className="max-w-5xl mx-auto px-6">
        <h2 className="text-4xl md:text-6xl font-bold mb-8">
          Don’t Let Your Equipment Sit Dead All Winter<br />Get the $89 Special Today
        </h2>
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <CTAButton />
          <a
            href="https://wa.me/19365294748?text=Hey%20David%2C%20book%20me%20for%20the%20%2489%20winterizing"
